...
This HUD is a replica of Woolen's HUD as seen from his videos on Youtube. The main HUD folder contains the newest version, the elements from the older versions can be found in the "alternatives" folder.
