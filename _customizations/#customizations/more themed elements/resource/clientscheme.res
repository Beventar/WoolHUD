Scheme
{
	BaseSettings
	{
		...
		ReplayBrowser.Button.DepressedBgColor				"ahudBlackLight"
		ReplayBrowser.Button.DepressedFgColor				"ahudWhite"
		...
		Econ.Button.DepressedBgColor			"ahudBlackLight"
		Econ.Button.DepressedFgColor			"ahudWhite"
		...
		CheckButton.Border1  			"ahudDullWhite" 		// the left checkbutton border
		CheckButton.Border2  			"ahudDullWhite"			// the right checkbutton border
		CheckButton.Check				"ahudDullWhite"			// color of the check itself
		CheckButton.HighlightFgColor	"ahudDullWhite"

		ComboBoxButton.ArrowColor		"ahudDullWhite"
		ComboBoxButton.ArmedArrowColor	"ahudDullWhite"
		...
		RadioButton.TextColor			"ahudWhite"
